...
<head>
    ...
    <link rel="icon" type="image/png" href="/images/logos/fav-piscina.png" />
    <!-- Google Fonts -->
 ...
 <section class="section-style-2 section-contact-us">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h2 class="title" >Piscinas y Restaurante Polideportivo</h2>
                    <div class="section-starter"></div>
                    <div class="row">
                        <div class="col-sm-6 office-box" >
                            <h4 class="subtitle">Viterbo - Caldas</h4>
                            <div class="address-line"><i class="fa fa-map-marker"></i>500 metros Via Viterbo - Canaan</div>
                            <div class="address-line"><i class="fa fa-user"></i>Luis Bernardo Yepes Muñoz</div>
                            <div class="address-line"><i class="fa fa-phone"></i>869 4890</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 text-center">
                <h2 class="subtitle wide"><strong>Piscinas y Restaurante Polideportivo</strong></h2>
                <p>500 metros Via Viterbo - Canaan</p>
                <p> <strong>Teléfono: </strong> 869 4890 <strong></p>

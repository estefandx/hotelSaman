        ...
        <div class="container">
            <div class="facilities-container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="content-box">
                            <img src="images/servicios/panel.png" class="img-centered img-responsive" data-animate="zoomIn" alt="facility-2">
                            <div class="tri-up"></div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="content-box">
                            <img src="images/servicios/hab2.jpg" class="img-centered img-responsive" data-animate="zoomIn" alt="facility-2">
                            <div class="tri-up"></div>
                            <h3 class="title">Cómodas Habitaciones</h3>
                            <p class="content">Nuestras habitaciones estan distribuidas de la mejor manera y con excelentes servicios como ducha con agua caliente, TV, wifi y muy buena ventilación para que su descanso sea el mejor.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="content-box">
                            <img src="images/servicios/hab1.jpg" class="img-centered img-responsive" data-animate="zoomIn" alt="facility-3">
                            <div class="tri-up"></div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3">
                        <div class="content-box">
                            <img src="images/servicios/recepcion.jpg" class="img-centered img-responsive" data-animate="zoomIn" alt="facility-1">
                            <div class="tri-up"></div>
                            <h3 class="title">Recepción</h3>
                            <p class="content">Nuestro servicio de recepción es 24 horas para estar siempre atentos a cualquier solicitud que requiera con prontitud.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="content-box">
                            ...
                            <div class="tri-up"></div>
                            <h3 class="title">Nuestro Instalaciones</h3>
                            <p class="content">Nuestras instalaciones estan adecuadas para que usted y su familia se sientan como en casa en cada uno de los espacios que brindamos.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="content-box">
                            ...
                            <p class="content">Servicio de restaurante con platos a la carta y ademas con platos tipicos de nuestra región. </p>
                        </div>
                    </div>
                </div>
            </div>
